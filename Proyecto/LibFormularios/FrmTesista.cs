...
namespace LibFormularios
{
    public partial class FrmTesista : LibFormularios.FrmPadre
    {
        ...
        {
            return new string[] { CodTesista.Text, Nombre.Text, ApellidoPaterno.Text, ApellidoMaterno.Text, DNI.Text, CarreraProfesional.Text, DtpFechaNacimiento.Value.ToShortDateString() };
        ...
        { //-- muestra la informacion contenida en el dataset de CLibro
            ...
            DtpFechaNacimiento.Text= aEntidad.ValorAtributo("FechaNacimiento");
        ...
        {
            if (CodTesista.Text.Trim() != "" && Nombre.Text.Trim() != "" && ApellidoPaterno.Text.Trim() != "" && ApellidoMaterno.Text.Trim() != "" && DtpFechaNacimiento.Value.ToShortDateString() != "")
            { 
                return true;
            }
            else
