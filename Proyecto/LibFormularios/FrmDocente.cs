...
namespace LibFormularios
{
    public partial class FrmDocente : LibFormularios.FrmPadre
    {
        ...
        {
            return new string[] {CodDocente.Text, Nombre.Text, ApellidoPaterno.Text, ApellidoMaterno.Text, DNI.Text, Gmail.Text,Telefono.Text, Categoria.Text , DepAcademico.Text,CboDisponibilidad.Text };
        ...
        { //-- muestra la informacion contenida en el dataset de CLibro
            ...
            Gmail.Text = aEntidad.ValorAtributo("Gmail");
